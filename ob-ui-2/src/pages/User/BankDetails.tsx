...
export const BankDetails = () =>
{
    ...
    const onSubmitQuestion = (aQuestion: TQuestion) =>
    {
        ...
        const lQuestionIndex = questions.findIndex((lQuestion: TQuestion) =>
        {
            return lQuestion.id == aQuestion.id;
        })
                            ...
                            <form className="py-2">
                                <div className="container flex flex-col">
                                    ...
                                    <div className="container flex flex-row mx-auto w-full justify-center items-center">
                                        ...
                                        <button type="button" onClick={handleSaveBank} className={`${altActionButtonClass} text-gray-light text-lg w-[10em] mx-3 hover:border-white`}> Save </button>
                                    </div>
                            </form>
                        </div>
                    </div>
